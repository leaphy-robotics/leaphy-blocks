...
messages["BKY_LEAPHY_BLUETOOTH_START_FILTERED_SCAN"] = "Start scannen naar Leaphy's";
messages["BKY_LEAPHY_BLUETOOTH_STOP_SCAN"] = "Stop scannen";
messages["BKY_LEAPHY_BLUETOOTH_ON_DISCOVER"] = "Wanneer BLE-apparaat wordt ontdekt";
